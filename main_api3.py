...
@app.route('/k_medoids_all', methods=['POST'])
def k__medoids_all():
...
@app.route('/k_medoids_2', methods=['POST'])
def k__medoids_2():
    ...
    df = pd.DataFrame(pre_data)
    df.to_csv (r'data_set_02.csv', index = False, header=True)

	############################################################################################################################

    data_input = pd.read_csv('data_set_02.csv')
    data = np.array([list(row) for row in data_input.values])
    print(type(data))
    print(len(data))
    ...
    normalized_df=(df-df.min())/(df.max()-df.min())
    #normalized_df=(df-df.mean())/df.std()
    normalized_df.to_csv (r'normalized_df_02.csv', index = False, header=True)
    ...
    df = pd.DataFrame(medoids)
    df.to_csv (r'medoids_02.csv', index = False, header=False)
    ...
    with open('normalized_df_02.csv', newline='') as f:
        reader = csv.reader(f)
        normalized_data = list(reader)

    print(normalized_data[len(normalized_data)-1])

    with open('medoids_02.csv', newline='') as f:
        reader = csv.reader(f)
        medoids_list_b = list(reader)
...
@app.route('/k_medoids_all_2', methods=['POST'])
def k__medoids_all_2():
...
@app.route('/k_medoids_3', methods=['POST'])
def k__medoids_3():
    ...
    df = pd.DataFrame(pre_data)
    df.to_csv (r'data_set_03.csv', index = False, header=True)

	############################################################################################################################

    data_input = pd.read_csv('data_set_03.csv')
    data = np.array([list(row) for row in data_input.values])
    print(type(data))
    print(len(data))
    ...
    normalized_df=(df-df.min())/(df.max()-df.min())
    #normalized_df=(df-df.mean())/df.std()
    normalized_df.to_csv (r'normalized_df_03.csv', index = False, header=True)
    ...
    df = pd.DataFrame(medoids)
    df.to_csv (r'medoids_03.csv', index = False, header=False)
    ...
    with open('normalized_df_03.csv', newline='') as f:
        reader = csv.reader(f)
        normalized_data = list(reader)

    print(normalized_data[len(normalized_data)-1])

    with open('medoids_03.csv', newline='') as f:
        reader = csv.reader(f)
        medoids_list_b = list(reader)
...
@app.route('/k_medoids_all_3', methods=['POST'])
def k__medoids_all_3():
